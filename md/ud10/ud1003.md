...
<div style="text-align:center;">
    <img src="../../img/ud10/choicebox.png" alt="choicebox" style="max-width:95%;" />
</div>
...
<div style="text-align:center;">
    <img src="../../img/ud10/listview_filtering_screenshot.png" alt="listview_filtering_screenshot" style="max-width:50%;" />
</div>
...
[Código postal de origen de ImageApp](https://translate.google.com/website?sl=en&tl=es&hl=ca&client=webapp&u=https://courses.bekwam.net/public_tutorials/source/bkcourse_imageapp_sources.zip){:target="_blank"}
