...
!!!note "A tener en cuenta"
	...
	public class ResultSetMetaDataExample {
		private static final JDBC_URL = "jdbc:mysql://localhost:3306/pr_tuNombre";
		private static final USUARIO = "pr_tuNombre";
		private static final PASSWD = "1234";
		
        public static void main(String[] args) {
            try (Connection con = DriverManager.getConnection(JDBC_URL, USUARIO, PASSWD);
                 Statement stmt = con.createStatement();
                 ResultSet rs = stmt.executeQuery("SELECT id, nombre, fecha_ingreso, precio FROM proveedores")) {
...
## Sentencias que no devuelven datos. `executeUpdate`
...
## Sentencias que devuelven datos. `executeQuery`
