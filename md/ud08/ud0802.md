...
???+ example "Revisa con cuidado el siguiente ejemplo"
    ...
    <img src="../../img/ud08/ud08_003.png" alt="image-20220419185525220" style="zoom:70%;" />
    
    3. Clase `Rectangulo`
        
    <img src="../../img/ud08/ud08_007.png" alt="ud08_007" style="zoom:70%;" />
...
Revisa con cuidado el **Ejemplo 2.2.2**
