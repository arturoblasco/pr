...
<div style="text-align: center;"><img src="../../img/ud08/ud08_003.png" alt="ud08_003" style="zoom: 90%;" /></div>
...
???+ example "Ejemplo 5.6"
    ...
    > Una interfaz es una **maqueta** contenedora de una lista de métodos abstractos y datos miembro (de tipos primitivos o de clases). Los atributos, si existen, son implícitamente consideradas `static` y `final`. Los métodos, si existen, son implícitamente considerados `public`.<br /><br />
